...
#define DEVICE_VERSION_YEAR 	0x2016
#define DEVICE_VERSION_MONTH	0x06
#define DEVICE_VERSION_DAY		0x23
#define DEVICE_VERSION  		((DEVICE_VERSION_YEAR << 16) | (DEVICE_VERSION_MONTH << 8) | DEVICE_VERSION_DAY)
...
#define DEF_INDICATOR_TYPE      ENC_DISPLAY_MODE_BAR
#define DEF_PHENOTYPE           ENC_CONTROL_TYPE_ROTARY
